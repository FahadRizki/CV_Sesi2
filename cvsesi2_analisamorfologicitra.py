# -*- coding: utf-8 -*-
"""CVsesi2_AnalisaMorfologiCitra.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1jYoZ9BSr4jR6w71t6EzvlECe6ujj-Ifc
...
# Baca citra
img = cv2.imread('motogp.jpg', 0)  # Ganti 'input_image.jpg' dengan nama citra Anda
cv2_imshow( img)
...
# Baca citra
img = cv2.imread('download.jpg', 0)  # Ganti 'input_image.jpg' dengan nama citra Anda
cv2_imshow( img)
...
img_path = "maeng.jpg"  # Ganti dengan path citra Anda di Google Colab
...
img_url = "download.jpg"  # Ganti dengan URL citra Anda atau path lokal
...
# Baca citra biner
binary_image = cv2.imread('maeng.jpg', cv2.IMREAD_GRAYSCALE)
